...
public class TargetedBootstrapperTest {
	...
	public void testIfBootstrapperCreatesExpectedFiles() throws Throwable {
		...
		URL libraryURL = getClass().getClassLoader().getResource("IL2_and_IL15_Combo.elib");
		String library = Paths.get(libraryURL.toURI()).toString();

		URL diaURL = Objects.requireNonNull(getClass().getClassLoader().getResource("IL2A_GPFDIA_0combined.dia"));
