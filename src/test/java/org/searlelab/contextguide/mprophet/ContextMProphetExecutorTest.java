...
public class ContextMProphetExecutorTest {
	...
	public void test() throws Throwable {
		...
		assertNotNull("DIA file not found. ", diaFileName);
		...
		ContextMProphetExecutor.executeContextMProphet(libraryPath.toString(), fastaPath.toString(), diaPath.toString(), massListPath);
	}	
}
